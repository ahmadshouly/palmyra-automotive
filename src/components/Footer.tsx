...
export default async function Footer() {
  ...
  const waUrl = whatsappLink(settings.whatsappNumber);
      ...
      <div className="container-page grid gap-8 py-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            {waUrl && (
              <li>
                <a href={waUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-white">
